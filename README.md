...
### Игра против бота:
- [x] Реализация алгоритма игры в шахматы для бота (можно использовать готовые библиотеки, например python-chess).
- [x] Разные уровни сложности бота.
...
- [x] Чат: общение между игроками во время игры.
